...
export default async function PreviewUserLinkSharingPage({
  ...
  return (
    <MainContainer>
      ...
      <div className="flex justify-center max-h-[calc(100%-80px)] short-height-desktop:max-h-[calc(100%-145px)] z-10 flex-1 mt-[60px] sm:mt-[-129px] sm:max-h-[calc(100%-270px)] short-height-desktop:mt-[-170px] ">
